...
async function setupDatabase() {
	console.info('🚀 Setting up LeCodeR database...\n');
	...
	try {
		...
		if (!isConnected) {
			console.info('❌ Database connection failed. Please ensure PostgreSQL is running.');
			console.info('💡 Try running: ./start-database.sh');
			process.exit(1);
		}
